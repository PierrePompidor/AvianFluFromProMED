// Author : Pierre Pompidor / 13/06/2023
...
function setMarkers(source) {
  ...
  else document.getElementById("nbFilteredEvents").innerHTML = "<h3>"+nbEvents+"</h3>";
}
...
var map = L.map('mapid', {zoomControl: false, gridControl:false, maxBoundsViscosity: 1.0}).setView([48.833, 2.333], 1); 
var mapzoom = L.map('mapzoomid', {zoomControl: false, attributionControl: false, gridControl:false, maxBoundsViscosity: 1.0}).setView([48.833, 2.333], 4);
var cible = L.circleMarker([0, 0], {radius:7, stroke:1, color: 'blue', fillColor: 'blue', fillOpacity: 0.5});
cible.addTo(mapzoom);
